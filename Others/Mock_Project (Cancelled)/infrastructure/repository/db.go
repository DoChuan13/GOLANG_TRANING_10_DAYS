...
func (r dbRepository) InsertData(
	ctx context.Context, objectProcess model.ObjectProcess, args []interface{},
) error {
...
func (r dbRepository) ClearTopic(ctx context.Context, object model.ObjectProcess) error {
